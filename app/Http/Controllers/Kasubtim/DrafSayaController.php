...
class DrafSayaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kasubtim.draf-saya.index', compact('drafSurats', 'stats'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('kasubtim.draf-saya.create', compact('suratMasuks', 'templates'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            DB::transaction(function() use ($request, $validated) {
                ...
                if ($kabag) {
                    $kabag->notify(new \App\Notifications\SuratNotification(
                        'Review Tingkat 2',
                        "Kasubtim telah mengunggah draf surat baru dan menunggu review Anda.",
                        route('kabag.review.index')
                    ));
                }
            });

            return redirect()->route('kasubtim.draf-saya.index')->with('success', 'Draf surat berhasil diunggah dan dikirim untuk reviu Kabag.');
    ...
    public function show(DrafSurat $drafSurat)
    {
        ...
        return view('kasubtim.draf-saya.show', compact('drafSurat'));
    }
    ...
    public function edit(DrafSurat $drafSurat)
    {
        ...
        return view('kasubtim.draf-saya.edit', compact('drafSurat'));
    }
    ...
    public function update(Request $request, DrafSurat $drafSurat)
    {
        ...
        return redirect()->route('kasubtim.draf-saya.index')->with('success', 'Draf surat revisi berhasil diunggah.');
    }
    ...
    public function destroy(DrafSurat $drafSurat)
    {
        ...
        return redirect()->route('kasubtim.draf-saya.index')->with('success', 'Draft surat berhasil dihapus.');
    }
}
