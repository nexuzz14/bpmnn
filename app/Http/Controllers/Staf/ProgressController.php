...
class ProgressController extends Controller
{
    public function index()
    {
        ...
        if ($role === 'kepala_bagian') {
            ...
            return view('staf.progress.index', compact('drafSurats', 'stats', 'header', 'role', 'riwayatSelesai'));
        } else {
            $drafSurats = $drafSuratsQuery->paginate(10);
        ...
        return view('staf.progress.index', compact('drafSurats', 'stats', 'header', 'role'));
    }
    ...
    public function show($id)
    {
        ...
        return view('staf.progress.show', compact('drafSurat'));
    }
}
