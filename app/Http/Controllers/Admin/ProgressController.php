...
class ProgressController extends Controller
{
    public function index()
    {
        ...
        if ($role === 'kepala_bagian') {
            ...
            return view('admin.progress.index', compact('drafSurats', 'stats', 'header', 'role', 'riwayatSelesai'));
        } else {
            $drafSurats = $drafSuratsQuery->paginate(10);
        ...
        return view('admin.progress.index', compact('drafSurats', 'stats', 'header', 'role'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.progress.show', compact('drafSurat'));
    }
}
