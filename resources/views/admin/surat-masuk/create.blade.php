    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden max-w-4xl">
        ...
        @if ($errors->any())
            <div class="bg-red-50 text-red-800 p-4 border-b border-red-100 flex items-start gap-3">
                ...
                <div>
                    <h4 class="text-sm font-bold mb-1">Gagal menyimpan surat masuk</h4>
        ...
        <form action="{{ route('admin.surat-masuk.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:px-8 sm:py-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="sifat" id="sifat" class="w-full rounded-lg border-gray-300 focus:border-role-admin focus:ring-role-admin shadow-sm transition-colors text-gray-500" required>
                ...
                <div class="space-y-2 md:col-span-2 mt-4">
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-10 flex flex-col items-center justify-center text-center hover:bg-gray-50 transition-colors relative cursor-pointer" onclick="document.getElementById('file_surat').click()">
                        ...
                        <p class="text-xs text-gray-400 mt-3">PDF / Word maks. 2 MB <br><span class="text-orange-500 font-medium">(Opsional: Boleh dikosongkan jika belum ada scan)</span></p>
