...
@php
    ...
    $backRoute = match($role) {
        'admin' => route('admin.progress.index'),
        'tu' => route('tu.progress.index'),
        'kepala_biro' => route('kabiro.progress.index'),
        'kepala_bagian' => route('kabag.progress.index'),
        'kepala_sub_tim' => route('kasubtim.progress.index'),
        'staf' => route('staf.progress.index'),
        default => '#'
    };
@endphp
        <div class="flex items-center gap-4">
            <a href="{{ $backRoute }}" class="p-2 rounded-lg text-gray-500 hover:bg-gray-100 transition-colors">
