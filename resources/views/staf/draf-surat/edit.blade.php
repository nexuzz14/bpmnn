<x-app-layout>
    <div class="mb-6 flex items-center gap-4">
        <a href="{{ route('staf.draf-surat.show', $drafSurat) }}" class="w-10 h-10 bg-white border border-gray-200 rounded-lg flex items-center justify-center text-gray-500 hover:bg-gray-50 transition-colors shadow-sm">
        ...
        <div class="space-y-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6">
                    ...
                    <form action="{{ route('staf.draf-surat.update', $drafSurat) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
