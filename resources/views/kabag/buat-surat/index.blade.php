<x-app-layout>
    ...
    <form method="GET" action="{{ route('kabag.buat-surat.index') }}" class="flex flex-col sm:flex-row gap-4 mb-6">
        <div class="flex-1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col relative overflow-hidden">
            ...
            <div class="flex items-center justify-between border-t border-gray-100 pt-4 mt-auto">
                ...
                <a href="{{ route('kabag.draf-saya.create', ['template' => $tpl->id]) }}" class="px-4 py-1.5 bg-white border border-[#701a35] text-[#701a35] hover:bg-[#701a35] hover:text-white font-bold rounded transition-colors text-sm shadow-sm">
                    Gunakan Template
                </a>
            </div>
        </div>
    ...
    <div class="flex justify-center border-t border-gray-100 pt-8 pb-4">
        <a href="{{ route('kabag.draf-saya.create', ['template' => 'blank']) }}" class="px-6 py-2.5 bg-white border border-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors shadow-sm text-sm">
