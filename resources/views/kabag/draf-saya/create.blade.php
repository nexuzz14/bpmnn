<x-app-layout>
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">Unggah draft surat untuk direview oleh Kabiro</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6">
            <form id="form-draf-surat" action="{{ route('kabag.draf-saya.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Catatan untuk Kabiro</label>
